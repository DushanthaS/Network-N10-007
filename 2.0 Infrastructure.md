...
- TIA/EIA 568b:
  ...
  - viii. Brown
- Crossover: 
  - Cable that has two wires crossed (1 and 3, 2 and 6). Used to directly network
two PCs without using a hub or switch. (same goes with switch to switch connection), this is nothging to do with 568A/B
- Straight-through: 
